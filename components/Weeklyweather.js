  ...
  return (
    <div className="weekly">
      <h3 className="weekly__title">
        Weekly <span>Weather Forecast</span>
      </h3>

      {/* Check if the weekly weather is available or not */}
      {/* If available then map on every item */}
            ...
            <div className="weekly__card">
              <div className="weekly__inner">
                ...
                <div className="weekly__right-content">
                  ...
                  <h5>{capitalizeFirstLetter(weather.weather[0].description)}</h5>
                </div>
              </div>
            </div>
          );
